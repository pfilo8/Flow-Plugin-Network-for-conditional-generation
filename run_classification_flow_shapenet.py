...
y_train_hat = predict(flow, x_train, num_classes, log_weights=log_p_y, mapping=mapping)
y_test_hat = predict(flow, x_test, num_classes, log_weights=log_p_y, mapping=mapping)
