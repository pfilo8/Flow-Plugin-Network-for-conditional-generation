...
pd.DataFrame(ys_train, columns=CLASSES).to_csv(data_dir / Path('y_train.csv'), index=False)
pd.DataFrame(ys_valid, columns=CLASSES).to_csv(data_dir / Path('y_valid.csv'), index=False)
pd.DataFrame(ys_test, columns=CLASSES).to_csv(data_dir / Path('y_test.csv'), index=False)
